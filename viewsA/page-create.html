      ...
      <div class="card-body">
         <div class="row">
            ...
            <div class="col-lg-8 col-md-8">
               <ul class="d-flex nav nav-pills text-center" id="event-pills-tab"
                  role="tablist">
                  <li class="nav-item">
                     <a class="nav-link btn btn-outline-primary active show"
                        data-toggle="pill" href="#pill-1" role="tab"
                        aria-selected="true">Form</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link btn btn-outline-primary"
                        data-toggle="pill" href="#pill-2" role="tab"
                        aria-selected="false">Options</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link btn btn-outline-primary"
                        data-toggle="pill" href="#pill-3" role="tab"
                                 ...
                                 <div class="col-lg-12">
                                    <div class="form-group">
                                       ...
                                       <textarea class="form-control
                                          ...
                                          rows="4" placeholder="Enter specific
