   ...
   <div class="row">
      <div class="col-sm-12 col-lg-6">
         <div class="card">
            ...
            <div class="card-body">
               <p class="mb-2">Lorem Ipsum is simply dummy text of the printing
         ...
         <div class="card">
            ...
            <div class="card-body">
               ...
               <button type="button" class="btn btn-outline-secondary
                  rounded-pill mt-2">Secondary</button>
               ...
               <button type="button" class="btn btn-outline-dark rounded-pill
                  mt-2">Dark</button>
               <button type="button" class="btn btn-outline-link rounded-pill
                  mt-2">Link</button>
            </div>
         </div>
      </div>
         ...
         <div class="card">
            ...
            <div class="card-body">
               ...
               <button type="button" class="mt-2 btn btn-secondary
                  rounded-pill"><i class="ri-heart-fill"></i>Secondary</button>
         ...
         <div class="card">
            ...
            <div class="card-body">
               <p class="mb-2">Lorem Ipsum is simply dummy text of the printing
                  ...
                  standard dummy text ever</p>
               <button type="button" class="btn btn-outline-primary rounded-pill
                  mt-2"><i class="ri-heart-line"></i>Primary</button>
               <button type="button" class="btn btn-outline-secondary
                  rounded-pill mt-2"><i class="ri-alert-line"></i>Secondary</button>
               <button type="button" class="btn btn-outline-success rounded-pill
                  mt-2"><i class="ri-heart-line"></i>Success</button>
               <button type="button" class="btn btn-outline-danger rounded-pill
                  mt-2"><i class="ri-alert-line"></i>Danger</button>
               <button type="button" class="btn btn-outline-warning rounded-pill
                  mt-2"><i class="ri-heart-line"></i>Warning</button>
               <button type="button" class="btn btn-outline-info rounded-pill
                  mt-2"><i class="ri-alert-line"></i>Info</button>
               <button type="button" class="btn btn-outline-dark rounded-pill
                  mt-2"><i class="ri-alert-line"></i>Dark</button>
               <button type="button" class="btn btn-outline-link rounded-pill
                  mt-2"><i class="ri-heart-line"></i>Link</button>
            </div>
         </div>
      </div>
   </div>
         ...
         <div class="card">
            ...
            <div class="card-body">
               ...
               <button type="button" class="btn btn-primary btn-block">Block
                  level button</button>
               <button type="button" class="btn btn-success btn-block">Block
                  level button</button>
            </div>
         </div>
      </div>
      <div class="col-sm-12 col-lg-6">
         <div class="card">
            ...
            <div class="card-body">
               ...
               <button type="button" class="btn btn-link"><i class="ri-moon-fill
                     pr-0"></i></button>
         ...
         <div class="card">
            ...
            <div class="card-body">
               <p class="mb-2">Lorem Ipsum is simply dummy text of the printing
                  and typesetting industry. Lorem Ipsum has been the industry's
                  standard dummy text ever</p>
               <button type="button" class="mt-2 btn btn-primary" disabled>Primary
                  button</button>
               <button type="button" class="mt-2 btn btn-success" disabled>Button</button>
               <button type="button" class="mt-2 btn btn-outline-primary"
      ...
      <div class="col-sm-12 col-lg-6">
         ...
         <div class="card">
            ...
            <div class="card-body">
               ...
               <div class="d-block">
                  <div class="btn-group mt-2" role="group" aria-label="Basic
                     example">
