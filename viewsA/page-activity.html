      ...
      <div class="col-lg-12 mb-3">
         <div class="d-flex flex-wrap align-items-top justify-content-between">
            <div class="iq-members">
               ...
               <p class="pb-3">Use the power of our comprehensive activity log
                  to complete and support a current activity. </p>
            </div>
            <div class="mt-0">
               <!-- Large modal -->
         ...
         <ul class="d-flex nav nav-pills text-center" id="pills-tab"
            ...
            <li class="nav-item">
               <a class="nav-link btn btn-outline-primary" data-toggle="pill"
                  href="#pills-2" role="tab" aria-selected="false">Campaigns</a>
            </li>
            <li class="nav-item">
               <a class="nav-link btn btn-outline-primary" data-toggle="pill"
            ...
            <li class="nav-item">
               <a class="nav-link btn btn-outline-primary" data-toggle="pill"
                  href="#pills-4" data-hide="#view-event-last" role="tab"
                     ...
                     <table class="table table-hover">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="dropdown">
                                    <span class="dropdown-toggle1" id="dropdownMenuButton19"
                                       data-toggle="dropdown"
                                       aria-expanded="false" role="button">
                                       <i class="fas fa-cog"></i>
                                    </span>
                     ...
                     <table class="table table-hover">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="dropdown">
                                    <span class="dropdown-toggle1" id="dropdownMenuButton20"
                                       data-toggle="dropdown"
                                       aria-expanded="false" role="button">
                                       <i class="fas fa-cog"></i>
                                    </span>
