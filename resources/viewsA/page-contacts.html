      ...
      <div class="col-lg-12 mb-3">
         <div class="d-flex flex-wrap align-items-top justify-content-between">
            <div class="iq-members">
               ...
               <p class="pb-3">It powers your email contacts, and it rears its
                  head in your system by letting you segment them.</p>
            </div>
            <div class="mt-0">
         ...
         <ul class="d-flex nav nav-pills text-center" id="pills-tab"
            ...
            <li class="nav-item">
               <a class="nav-link btn btn-outline-primary" data-toggle="pill"
                  href="#pills-2" role="tab" aria-selected="false">Segment</a>
            </li>
            <li class="nav-item">
               <a class="nav-link btn btn-outline-primary" data-toggle="pill"
                  href="#pills-3" data-hide="#view-event" role="tab"
                        ...
                        <div class="card-body">
                           <div class="d-flex align-items-center">
                              <img src="../assets/images/icon/01.png"
                                 class="img-fluid avatar-60" alt="image">
                  ...
                  <div class="col-sm-12">
                     <table class="table table-hover">
                        ...
                        <tbody>
                           ...
                           <tr>
                              <td>
                                 <img src="../assets/images/options/02.png"
                           ...
                           <tr>
                              <td>
                                 <img src="../assets/images/options/05.png"
                           ...
                           <tr>
                              <td>
                                 <img src="../assets/images/options/06.png"
                                    class="bg-success-light rounded p-3
                                    img-fluid avatar-70" alt="image">
                              </td>
                              <td>
                              ...
                              <td>
                                 <div class="dropdown">
                                    <span class="dropdown-toggle1" id="dropdownMenuButton_1"
                                       data-toggle="dropdown"
                                       aria-expanded="false" role="button">
                                       <i class="fas fa-cog"></i>
                                    </span>
                           ...
                           <tr>
                              <td>
                                 <img src="../assets/images/options/07.png"
                                    class="bg-info-light rounded p-3 img-fluid
                                    avatar-70" alt="image">
                              </td>
                              <td>
                              ...
                              <td>
                                 <div class="dropdown">
                                    <span class="dropdown-toggle1" id="dropdownMenuButton_two"
                                       data-toggle="dropdown"
                                       aria-expanded="false" role="button">
                                       <i class="fas fa-cog"></i>
                                    </span>
                                    <div class="dropdown-menu
                                       dropdown-menu-right"
                                       aria-labelledby="dropdownMenuButton_two"
                                       style="">
                                       <a class="dropdown-item" href="#">Show
                                          activity</a>
                                       <a class="dropdown-item" href="#">View
                     ...
                     <table class="table table-hover">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="dropdown">
                                    <span class="dropdown-toggle1" id="dropdownMenuButton_6"
                                       data-toggle="dropdown"
                                       aria-expanded="false" role="button">
                                       <i class="fas fa-cog"></i>
                                    </span>
                                    <div class="dropdown-menu
                                       dropdown-menu-right"
                                       aria-labelledby="dropdownMenuButton_6"
                                       style="">
                                       <a class="dropdown-item" href="#">Show
                                          activity</a>
                                       <a class="dropdown-item" href="#">View
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="dropdown">
                                    <span class="dropdown-toggle1" id="dropdownMenuButton_5"
                                       data-toggle="dropdown"
                                       aria-expanded="false" role="button">
                                       <i class="fas fa-cog"></i>
                                    </span>
                                    <div class="dropdown-menu
                                       dropdown-menu-right"
                                       aria-labelledby="dropdownMenuButton_5"
                                       style="">
                                       <a class="dropdown-item" href="#">Show
                                          activity</a>
                                       <a class="dropdown-item" href="#">View
