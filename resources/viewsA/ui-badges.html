      ...
      <div class="row">
        <div class="col-sm-12 col-lg-6">
          <div class="card">
            ...
            <div class="card-body">
              <p>Badges scale to match the size of the immediate parent element
                by using relative font sizing and <code>em</code> units.</p>
              <h1 class="mt-2">Example heading <span class="badge
                  badge-primary">New</span></h1>
              <h2 class="mt-2">Example heading <span class="badge
                  badge-secondary">New</span></h2>
              <h3 class="mt-2">Example heading <span class="badge
                  badge-success">New</span> </h3>
              <h4 class="mt-2">Example heading <span class="badge badge-danger">New</span></h4>
              <h5 class="mt-2">Example heading <span class="badge
                  badge-warning">New</span></h5>
        ...
        <div class="col-sm-12 col-lg-6">
          <div class="card">
            ...
            <div class="card-body">
              <p class="mb-2">Add any of the below mentioned modifier classes to
                change the appearance of a badge.</p>
              ...
              <p class="mb-2">Use the <code>.badge-pill</code> modifier class to
                make badges more rounded (with a larger <code>border-radius</code>
                and additional horizontal <code>padding</code>). Useful if you
              ...
              <p class="mb-2">Using the contextual <code>.badge-*</code> classes
                on an <code>&lt;a&gt;</code> element quickly provide <em>actionable</em>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <span class="mt-2 badge border border-secondary text-secondary
                mt-2">Secondary</span>
              ...
              <p class="mb-2">Use the <code>.badge-pill</code> modifier class to
                ...
                and additional horizontal <code>padding</code>). Useful if you
                miss the badges from v3.</p>
              <span class="mt-2 badge badge-pill border border-primary
                text-primary">Primary</span>
              <span class="mt-2 badge badge-pill border border-secondary
                text-secondary">Secondary</span>
              <span class="mt-2 badge badge-pill border border-success
                text-success">Success</span>
              <span class="mt-2 badge badge-pill border border-danger
                text-danger">Danger</span>
              <span class="mt-2 badge badge-pill border border-warning
                text-warning">Warning</span>
              <span class="mt-2 badge badge-pill border border-info text-info">Info</span>
              <span class="mt-2 badge badge-pill border border-light
              ...
              <a href="#" class="mt-2 badge border border-secondary
                text-secondary">Secondary</a>
