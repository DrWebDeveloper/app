        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-block card-stretch card-height">
                <div class="card-body">
                    ...
                    <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Scelerisque.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="card card-block card-stretch card-height">
                ...
                <div class="card-body">
                    <ul class="list-inline p-0 m-0">
                        ...
                        <li class="d-flex align-items-center mb-3">
                            <div class="profile-icon iq-icon-box  bg-warning-light svg-warning text-center">
                        ...
                        <li class="d-flex align-items-center mb-3">
                            <div class="profile-icon iq-icon-box  bg-success-light svg-success text-center">
                                <svg width="24" height="20" viewBox="0 0 24 20" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0)">
                                        <path
                        ...
                        <li class="d-flex align-items-center">
                            <div class="profile-icon iq-icon-box bg-info-light svg-info text-center">
                                <svg width="24" height="20" viewBox="0 0 24 20" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0)">
                                        <path
                            ...
                            <ul class="list-inline p-0 mb-0">
                                <li>
                                    <div class="d-flex align-items-center justify-content-between mb-3 row">
                                        ...
                                        <div class="col-2">
                                            <div class="percentage float-right text-danger font-weight-bold">
                                                75%
                                            </div>
                                        </div>
                                    </div>
