...
<div class="container-fluid">
   <div class="card">
      <div class="card-body">
         <div class="row">
            <div class="col-lg-12">
               <div class="d-flex align-items-top border-bottom
                           ...
                           <div class="col-lg-6 col-md-6 mb-3">
                              <div class="form-group">
                                 ...
                                 <select name="type" class="selectpicker
                                    ...
                                    <option>When contact from audience opens an
                                       email</option>
                                    <option>When contact from audience clicks an
                                       email</option>
                                 </select>
                              </div>
                           </div>
                           <div class="col-lg-6 col-md-6 mb-3">
                              <div class="form-group">
                                 ...
                                 <select name="type" class="selectpicker
                                    ...
                                    <option>2. Send to the most engaged contacts
                                       first to optimize delivery</option>
                                    <option>3. Send this campaign to each
                                       contacts optimal open time over the next
                                       24 hours</option>
                                 </select>
                              </div>
                           </div>
                           ...
                           <div class="col-lg-12 mb-3">
                              <div class="form-group">
                                 ...
                                 <textarea class="form-control description"
                                    id="exampleFormControlTextarea2" rows="4"
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="logo mt-3">
                                    <img src="../assets/images/logo.png"
                                       class="img-fluid avatar-60" alt="logo">
                                 </div>
                              </div>
                           </div>
                        </div>
                        <button type="submit" class="btn btn-primary btn-lg mt-4">Save
                           Info</button>
                     </form>
                  </div>
               </div>
