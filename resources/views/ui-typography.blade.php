   ...
   <div class="row">
         ...
         <div class="card">
            ...
            <div class="card-body">
               <p>Traditional heading elements are designed to work best in the
                  ...
                  possible to enable <a href="https://getbootstrap.com/"
         ...
         <div class="card">
            ...
            <div class="card-body">
               ...
               <p><s>This line of text is meant to be treated as no longer
                     accurate.</s></p>
               <p><ins>This line of text is meant to be treated as an addition
                     to the document.</ins></p>
      ...
      <div class="col-sm-12 col-lg-6">
         <div class="card">
            ...
            <div class="card-body">
               <p><code>.h1</code> through <code>.h6</code> classes are also
         ...
         <div class="card">
            ...
            <div class="card-body">
               <p>Remove the default <code>list-style</code> and left margin on
                  list items (immediate children only). <strong>This only
                     applies to immediate children list items</strong>, meaning
      ...
      <div class="col-sm-12">
         <div class="card">
            ...
            <div class="card-body">
               <p>Align terms and descriptions horizontally by using our grid
               ...
               <dl class="row">
                  ...
                  <dd class="col-sm-9">A description list is perfect for
                     defining terms.</dd>
                  <dt class="col-sm-3">Euismod</dt>
                  <dd class="col-sm-9">
                     <p>Vestibulum id ligula porta felis euismod semper eget
