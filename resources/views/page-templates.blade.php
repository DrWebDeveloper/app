         ...
         <div class="d-flex flex-wrap align-items-top justify-content-between">
            ...
            <div class="mt-0">
               <a class="btn btn-outline-primary btn-lg iq-create-btn"
                  href="page-create-templates.html">Create Prospects Express</a>
            </div>
         </div>
      </div>
                           ...
                           <div class="forms-box">
                              ...
                              <div class="forms-text d-flex flex-wrap
                                 ...
                                 <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu
                                       dropdown-menu-right"
                                       aria-labelledby="dropdownMenuButton=8"
                                       style="">
                                       <a class="dropdown-item copys" href="#"><i
                                             class="far fa-copy mr-2"></i>Copy</a>
                                       <a href="#" class="dropdown-item edit-note1" data-toggle="modal" data-target="#edit-note1"><i class="las la-pen mr-3"></i>Edit</a>
                           ...
                           <div class="forms-box">
                              ...
                              <div class="forms-text d-flex flex-wrap
                                 ...
                                 <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu
                                       dropdown-menu-right"
                                       aria-labelledby="dropdownMenuButton=six"
                                       style="">
                                       <a class="dropdown-item copys" href="#"><i
                                             class="far fa-copy mr-2"></i>Copy</a>
                                       <a href="#" class="dropdown-item edit-note1" data-toggle="modal" data-target="#edit-note1"><i class="las la-pen mr-3"></i>Edit</a>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                           <div class="forms-box">
                              ...
                              <div class="forms-text d-flex flex-wrap
                                 ...
                                 <div class="dropdown">
                                    <span class="dropdown-toggle1"
                                       id="dropdownMenuButton=thirteen"
                                       data-toggle="dropdown"
                                       aria-expanded="false" role="button">
                                       <i class="fas fa-cog mt-2"></i>
                                    </span>
                                    <div class="dropdown-menu
                                       dropdown-menu-right"
                                       aria-labelledby="dropdownMenuButton=thirteen"
                                       style="">
                                       <a class="dropdown-item copys" href="#"><i
                                             class="far fa-copy mr-2"></i>Copy</a>
                                       <a href="#" class="dropdown-item edit-note1" data-toggle="modal" data-target="#edit-note1"><i class="las la-pen mr-3"></i>Edit</a>
