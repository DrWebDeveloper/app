        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-block card-stretch card-height">
                ...
                <div class="card-body">
                    ...
                    <h1 class="mb-0">{{ App\Models\User::count() }}</h1>
                </div>
                </a>
            </div>
        </div>
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-block card-stretch card-height">
                ...
                <div class="card-body">
                    ...
                    <h1 class="mb-0">{{ count($purchases) }}</h1>
                </div>
                </a>
            </div>
        </div>
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-block card-stretch card-height">
                ...
                <div class="card-body">
                    ...
                    <h1 class="mb-0">{{ count($epurchases) }}</h1>
                </div>
                </a>
            </div>
        </div>
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-block card-stretch card-height">
                <div class="card-body">
                    ...
                    <h1 class="mb-0">{{ App\Models\User::where('membership','Premium')->count() }}</h1>
                </div>
            </div>
        </div>
        {{-- <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-block card-stretch card-height">
                <div class="card-body text-center">
                    ...
                    <h2 class="mb-2 mt-3 text-primary">{{ App\Models\Purchase::where('user_id',Auth::user()->id)->count() }}+</h2>
                    <h4>Purchases</h4>
                </div>
            </div>
        </div> --}}
            ...
            <div class="card card-block card-stretch card-height">
                <div class="card-body text-center">
                    ...
                    <h2 class="mb-2 mt-3 text-success">
                        @php
                            $cDate = Carbon\Carbon::parse(Auth::user()->created_at);

                        @endphp
                        {{ $cDate->diffInDays() }}+ Days
                    </h2>
                    <h4>Member Since</h4>
                </div>
            </div>
                ...
                <div class="card-body">
                    <ul class="list-inline p-0 m-0">
                        ...
                        <li class="d-flex align-items-center mb-3">
                                    <span class="bg-info-light rounded-small iq-card-icon-small mr-3">{{ $user->id }}</span>
                                    <p class="mb-0 font-size-16"><b>{{ $user->fname }}</b> joined on {{ date('l h:i A',strtotime($user->created_at)) }}</p>
                                </li>
            ...
            <div class="card card-block card-stretch card-height">
                ...
                <div class="card-body">
                    <ul class="list-inline p-0 m-0 iq-contact-rest">
                        <li class="mb-3 d-flex">
                            <span><i class="mr-3">
                                    <svg width="20" class="svg-icon" id="up-01" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <li class="mb-3 d-flex">
                            <span><i class="mr-3">
                                    <svg width="20" class="svg-icon" id="up-02" xmlns="http://www.w3.org/2000/svg"
                                        fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                    </svg>
                                </i></span>
                            <p class="mb-0 font-size-16 line-height">{{ $setting->site_phone }}</p>
                        </li>
                        <li class="mb-3 d-flex">
                            <span><i class="mr-3">
                                    <svg width="20" class="svg-icon" id="up-03" xmlns="http://www.w3.org/2000/svg"
                                        fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <p class="mb-0 font-size-16 line-height"><a href="/cdn-cgi/l/email-protection"
                                    class="__cf_email__"
                                    data-cfemail="412b2e292f0131332e31243335386f222e2c">{{ $setting->site_mail }}</a>
                            </p>
                        </li>
                        <li class="mb-3 d-flex">
                            <a href="javascript:void(0);" class="d-flex">
                                <i class="mr-3">
                                    <svg width="20" class="svg-icon" id="up-04" xmlns="http://www.w3.org/2000/svg"
                                        fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <li class="d-flex">
                            <span><i class="mr-3">
                                    <svg width="20" class="svg-icon" id="up-05" xmlns="http://www.w3.org/2000/svg"
                                        fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                    </svg>
                                </i></span>
                            <p class="mb-0 font-size-16 line-height">{{ $setting->site_address }}.</p>
                        </li>
                    </ul>
                </div>
            </div>
