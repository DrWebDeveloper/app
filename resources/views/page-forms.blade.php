   ...
   <div class="row">
      <div class="col-lg-12 mb-3">
         <div class="d-flex flex-wrap align-items-top justify-content-between">
            <div class="iq-members">
               ...
               <p class="pb-3">Grow your double Opt-In list using custom
                  templates and redirects using web form tool. </p>
            </div>
            <div class="mt-0">
               <a class="btn btn-outline-primary btn-lg iq-create-btn"
                  href="page-create.html">Create Form</a>
            </div>
         </div>
      </div>
      <div class="col-lg-8 col-md-8">
         <ul class="d-flex nav nav-pills text-center" id="pills-tab"
            role="tablist">
            <li class="nav-item">
               <a class="nav-link btn btn-outline-primary active show"
                  data-toggle="pill" href="#pills-1" role="tab"
                  aria-selected="true">Your Forms</a>
            </li>
            <li class="nav-item">
               <a class="nav-link btn btn-outline-primary" data-toggle="pill"
                  href="#pills-2" data-hide="#view-event" role="tab"
                     ...
                     <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                           <div class="forms-box">
                              <div class="bg-warning-light image-box text-center
                                 p-5">
                                 <img src="../assets/images/forms/02.png"
                                    class="img-fluid avatar-90" alt="image">
                              </div>
                              <div class="forms-text d-flex flex-wrap
                                 justify-content-between text-left">
                                 <div>
                                    <h5 class="mb-3"><i class="las la-file-alt
                                          text-dark mr-3"></i>Scale Form</h5>
                                    <p class="mb-0"><i class="las
                                          la-calendar-minus text-light mr-3
                                          font-size-18"></i>04 / 12 / 2020</p>
                                 </div>
                                 <div class="dropdown">
                                    <span class="dropdown-toggle1"
                                    ...
                                    <div class="dropdown-menu
                                       ...
                                       style="">
                                       <a class="dropdown-item copy copy" href="#" ><i
                                             class="far fa-copy mr-2" ></i>Copy</a>
                                       <a href="#" class="dropdown-item edit-note1" data-toggle="modal" data-target="#edit-note1"><i class="las la-pen mr-3"></i>Edit</a>
                                       <a class="dropdown-item" data-extra-toggle="delete" data-closest-elem=".item" href="#"><i
                                             class="ri-delete-bin-6-fill mr-2"></i>Delete</a>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                           <div class="forms-box">
                              <div class="bg-success-light image-box text-center
                                 p-5">
                                 <img src="../assets/images/forms/03.png"
                                    class="img-fluid avatar-90" alt="image">
                              </div>
                              <div class="forms-text d-flex flex-wrap
                                 justify-content-between text-left">
                                 <div>
                                    <h5 class="mb-3"><i class="las la-file-alt
                                          text-dark mr-3"></i>Citron Form</h5>
                                    <p class="mb-0"><i class="las
                                          la-calendar-minus text-light mr-3
                                          font-size-18"></i>07 / 12 / 2020</p>
                                 </div>
                                 <div class="dropdown">
                                    <span class="dropdown-toggle1"
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                           <div class="forms-box">
                              <div class="bg-danger-light image-box text-center
                                 p-5">
                                 <img src="../assets/images/forms/04.png"
                                    class="img-fluid avatar-90" alt="image">
                              </div>
                              <div class="forms-text d-flex flex-wrap
                                 justify-content-between text-left">
                                 <div>
                                    <h5 class="mb-3"><i class="las la-file-alt
                                          text-dark mr-3"></i> Authority Form</h5>
                                    <p class="mb-0"><i class="las
                                          la-calendar-minus text-light mr-3
                                          font-size-18"></i>08 / 12 / 2020</p>
                                 </div>
                                 <div class="dropdown">
                                    <span class="dropdown-toggle1"
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mb-0">
                           <div class="forms-box">
                              <div class="bg-success-light image-box text-center
                                 p-5">
                                 <img src="../assets/images/forms/05.png"
                                    class="img-fluid avatar-90" alt="image">
                              </div>
                              <div class="forms-text d-flex flex-wrap
                                 justify-content-between text-left">
                                 <div>
                                    <h5 class="mb-3"><i class="las la-file-alt
                                          text-dark mr-3"></i>Pink Circle Form</h5>
                                    <p class="mb-0"><i class="las
                                          la-calendar-minus text-light mr-3
                                          font-size-18"></i>09 / 12 / 2020</p>
                                 </div>
                                 <div class="dropdown">
                                    <span class="dropdown-toggle1"
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mb-0">
                           <div class="forms-box">
                              <div class="bg-danger-light image-box text-center
                                 p-5">
                                 <img src="../assets/images/forms/06.png"
                                    class="img-fluid avatar-90" alt="image">
                              </div>
                              <div class="forms-text d-flex flex-wrap
                                 justify-content-between text-left">
                                 <div>
                                    <h5 class="mb-3"><i class="las la-file-alt
                                          text-dark mr-3"></i>Marvel Form</h5>
                                    <p class="mb-0"><i class="las
                                          la-calendar-minus text-light mr-3
                                          font-size-18"></i>10 / 12 / 2020</p>
                                 </div>
                                 <div class="dropdown">
                                    <span class="dropdown-toggle1"
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mb-0">
                           <div class="forms-box">
                              <div class="bg-info-light image-box text-center
                                 p-5">
                                 <img src="../assets/images/forms/07.png"
                                    class="img-fluid avatar-90" alt="image">
                              </div>
                              <div class="forms-text d-flex flex-wrap
                                 justify-content-between text-left">
                                 <div>
                                    <h5 class="mb-3"><i class="las la-file-alt
                                          text-dark mr-3"></i>Blue Circle Form</h5>
                                    <p class="mb-0"><i class="las
                                          la-calendar-minus text-light mr-3
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mb-0">
                           <div class="forms-box">
                              <div class="bg-warning-light image-box text-center
                                 p-5">
                                 <img src="../assets/images/forms/08.png"
                                    class="img-fluid avatar-90" alt="image">
                              </div>
                              <div class="forms-text d-flex flex-wrap
                                 justify-content-between text-left">
                                 <div>
                                    <h5 class="mb-3"><i class="las la-file-alt
                                          text-dark mr-3"></i>Orange Cube Form</h5>
                                    <p class="mb-0"><i class="las
                                          la-calendar-minus text-light mr-3
                                          font-size-18"></i>12 / 12 / 2020</p>
                                 </div>
                                 <div class="dropdown">
                                    <span class="dropdown-toggle1"
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                           <div class="forms-box">
                              <div class="bg-danger-light image-box text-center
                                 p-5">
                                 <img src="../assets/images/forms/12.png"
                                    class="img-fluid avatar-90" alt="image">
                              </div>
                              <div class="forms-text d-flex flex-wrap
                                 justify-content-between text-left">
                                 <div>
                                    <h5 class="mb-3"><i class="las la-file-alt
                                          text-dark mr-3"></i>Yellow Circle Form</h5>
                                    <p class="mb-0"><i class="las
                                          la-calendar-minus text-light mr-3
                                          font-size-18"></i>08 / 12 / 2020</p>
                                 </div>
                                 <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu
                                       dropdown-menu-right"
                                       aria-labelledby="dropdownMenuButton-eight"
                                       style="">
                                       <a class="dropdown-item copy" href="#"><i
                                             class="far fa-copy mr-2"></i>Copy</a>
                                       <a href="#" class="dropdown-item edit-note1" data-toggle="modal" data-target="#edit-note1"><i class="las la-pen mr-3"></i>Edit</a>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mb-0">
                           <div class="forms-box">
                              <div class="bg-success-light image-box text-center
                                 p-5">
                                 <img src="../assets/images/forms/11.png"
                                    class="img-fluid avatar-90" alt="image">
                              </div>
                              <div class="forms-text d-flex flex-wrap
                                 justify-content-between text-left">
                                 <div>
                                    <h5 class="mb-3"><i class="las la-file-alt
                                          text-dark mr-3"></i>Pink Cube Form</h5>
                                    <p class="mb-0"><i class="las
                                          la-calendar-minus text-light mr-3
                                          font-size-18"></i>09 / 12 / 2020</p>
                                 </div>
                                 <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu
                                       dropdown-menu-right"
                                       aria-labelledby="dropdownMenuButton-nine"
                                       style="">
                                       <a class="dropdown-item copy" href="#"><i
                                             class="far fa-copy mr-2"></i>Copy</a>
                                       <a href="#" class="dropdown-item edit-note1" data-toggle="modal" data-target="#edit-note1"><i class="las la-pen mr-3"></i>Edit</a>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                           <div class="forms-box">
                              <div class="bg-warning-light image-box text-center
                                 p-5">
                                 <img src="../assets/images/forms/10.png"
                                    class="img-fluid avatar-90" alt="image">
                              </div>
                              <div class="forms-text d-flex flex-wrap
                                 justify-content-between text-left">
                                 <div>
                                    <h5 class="mb-3"><i class="las la-file-alt
                                          text-dark mr-3"></i>Orange Circle Form</h5>
                                    <p class="mb-0"><i class="las
                                          la-calendar-minus text-light mr-3
                                          font-size-18"></i>06 / 12 / 2020</p>
                                 </div>
                                 <div class="dropdown">
                                    <span class="dropdown-toggle1"
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mb-0">
                           <div class="forms-box">
                              <div class="bg-info-light image-box text-center
                                 p-5">
                                 <img src="../assets/images/forms/13.png"
                                    class="img-fluid avatar-90" alt="image">
                              </div>
                              <div class="forms-text d-flex flex-wrap
                                 justify-content-between text-left">
                                 ...
                                 <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu
                                       dropdown-menu-right"
                                       aria-labelledby="dropdownMenuButton-ten"
                                       style="">
                                       <a class="dropdown-item copy" href="#"><i
                                             class="far fa-copy mr-2"></i>Copy</a>
                                       <a href="#" class="dropdown-item edit-note1" data-toggle="modal" data-target="#edit-note1"><i class="las la-pen mr-3"></i>Edit</a>
                     ...
                     <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-6">
                           <div class="forms-box">
                              <div class="bg-info-light image-box text-center
                                 p-5">
                                 <img src="../assets/images/forms/09.png"
                                    class="img-fluid avatar-90" alt="image">
                              </div>
                              <div class="forms-text d-flex flex-wrap
                                 justify-content-between text-left">
                                 <div>
                                    <h5 class="mb-0"><i class="las la-file-alt
                                          text-dark mr-3"></i>Dapper Forms</h5>
                                 </div>
                                 <div class="dropdown">
                                    <span class="dropdown-toggle1"
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mb-0">
                           <div class="forms-box">
                              ...
                              <div class="forms-text d-flex flex-wrap
                                 ...
                                 <div>
                                    <h5 class="mb-0"><i class="las la-file-alt
                                          text-dark mr-3"></i>Cylinder Form</h5>
                                 </div>
                                 <div class="dropdown">
                                    <span class="dropdown-toggle1"
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mb-0">
                           <div class="forms-box">
                              ...
                              <div class="forms-text d-flex flex-wrap
                                 ...
                                 <div>
                                    <h5 class="mb-0"><i class="las la-file-alt
                                          text-dark mr-3"></i>Yellow Slant Form</h5>
                                 </div>
                                 <div class="dropdown">
                                    <span class="dropdown-toggle1"
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mb-0">
                           <div class="forms-box">
                              ...
                              <div class="forms-text d-flex flex-wrap
                                 ...
                                 <div>
                                    <h5 class="mb-0"><i class="las la-file-alt
                                          text-dark mr-3"></i>Blue Cube Form</h5>
                                 </div>
                                 <div class="dropdown">
                                    <span class="dropdown-toggle1"
                           ...
                           <div class="forms-box">
                              ...
                              <div class="forms-text d-flex flex-wrap
                                 ...
                                 <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu
                                       dropdown-menu-right"
                                       aria-labelledby="dropdownMenuButton-eleven"
                                       style="">
                                       <a class="dropdown-item copy" href="#"><i
                                             class="far fa-copy mr-2"></i>Copy</a>
                                       <a href="#" class="dropdown-item edit-note1" data-toggle="modal" data-target="#edit-note1"><i class="las la-pen mr-3"></i>Edit</a>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mb-0">
                           <div class="forms-box">
                              ...
                              <div class="forms-text d-flex flex-wrap
                                 ...
                                 <div>
                                    <h5 class="mb-0"><i class="las la-file-alt
                                          text-dark mr-3"></i>Blue Slant Form</h5>
                                 </div>
                                 <div class="dropdown">
                                    <span class="dropdown-toggle1"
                                       id="dropdownMenuButton-7"
                                       data-toggle="dropdown"
                                       aria-expanded="false" role="button">
                                       <i class="fas fa-cog mt-2"></i>
                                    </span>
                                    <div class="dropdown-menu
                                       dropdown-menu-right"
                                       aria-labelledby="dropdownMenuButton-7"
                                       style="">
                                       <a class="dropdown-item copy" href="#"><i
                                             class="far fa-copy mr-2"></i>Copy</a>
                                       <a href="#" class="dropdown-item edit-note1" data-toggle="modal" data-target="#edit-note1"><i class="las la-pen mr-3"></i>Edit</a>
                ...
                <div class="modal-body">
                    <div class="popup text-left">
                        <div class="media align-items-top justify-content-between">                            
                            <h3 class="mb-3">Weekly Planner</h4>
