        ...
        <div class="col-lg-12 mb-3">
            <div class="d-flex flex-wrap align-items-top justify-content-between">
                <div class="iq-members">
                    <h2 class="mb-2">Have any Questions? Here are the Answers!</h2>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="embed-responsive embed-responsive-4by3">
                                        <iframe width="560" height="315" src="https://www.youtube.com/embed/jprSALDoYX8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="embed-responsive embed-responsive-4by3">
                                ...
                                {{-- <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="forms-box">
                                     ...
                                     p-5">
                                            <img src="{{ url('public/assets/images/forms/11.png') }}"
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="forms-box">
                                     ...
                                     p-5">
                                            <img src="{{ url('public/assets/images/forms/12.png') }}"
                                                class="img-fluid avatar-90" alt="image">
                                        </div>
                                        <div class="forms-text d-flex flex-wrap
                                     justify-content-between text-left">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <div class="forms-box">
                                     ...
                                     p-5">
                                            <img src="{{ url('public/assets/images/forms/01.png') }}"
                                                class="img-fluid avatar-90" alt="image">
                                        </div>
                                        <div class="forms-text d-flex flex-wrap
                                     justify-content-between text-left">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <div class="forms-box">
                                     ...
                                     p-5">
                                            <img src="{{ url('public/assets/images/forms/02.png') }}"
                                                class="img-fluid avatar-90" alt="image">
                                        </div>
                                        <div class="forms-text d-flex flex-wrap
                                     justify-content-between text-left">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <div class="forms-box">
                                        <div class="bg-success-light image-box text-center
                                     p-5">
                                            <img src="{{ url('public/assets/images/forms/03.png') }}"
                                                class="img-fluid avatar-90" alt="image">
                                        </div>
                                        <div class="forms-text d-flex flex-wrap
                                     justify-content-between text-left">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <div class="forms-box">
                                        <div class="bg-danger-light image-box text-center
                                     p-5">
                                            <img src="{{ url('public/assets/images/forms/04.png') }}"
                                                class="img-fluid avatar-90" alt="image">
                                        </div>
                                        <div class="forms-text d-flex flex-wrap
                                     justify-content-between text-left">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <div class="forms-box">
                                        <div class="bg-info-light image-box text-center
                                     p-5">
                                            <img src="{{ url('public/assets/images/forms/13.png') }}"
                                                class="img-fluid avatar-90" alt="image">
                                        </div>
                                        <div class="forms-text d-flex flex-wrap
                                     justify-content-between text-left">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <div class="forms-box">
                                        <div class="bg-warning-light image-box text-center
                                     p-5">
                                            <img src="{{ url('public/assets/images/forms/10.png') }}"
                                                class="img-fluid avatar-90" alt="image">
                                        </div>
                                        <div class="forms-text d-flex flex-wrap
                                     justify-content-between text-left">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <div class="forms-box">
                                        <div class="bg-warning-light image-box text-center
                                     p-5">
                                            <img src="{{ url('public/assets/images/forms/08.png') }}"
                                                class="img-fluid avatar-90" alt="image">
                                        </div>
                                        <div class="forms-text d-flex flex-wrap
                                     justify-content-between text-left">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <div class="forms-box">
                                        <div class="bg-success-light image-box text-center
                                     p-5">
                                            <img src="{{ url('public/assets/images/forms/05.png') }}"
                                                class="img-fluid avatar-90" alt="image">
                                        </div>
                                        <div class="forms-text d-flex flex-wrap
                                     justify-content-between text-left">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <div class="forms-box">
                                        <div class="bg-info-light image-box text-center
                                     p-5">
                                            <img src="{{ url('public/assets/images/forms/07.png') }}"
                                                class="img-fluid avatar-90" alt="image">
                                        </div>
                                        <div class="forms-text d-flex flex-wrap
                                     justify-content-between text-left">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <div class="forms-box">
                                        <div class="bg-danger-light image-box text-center
                                     p-5">
                                            <img src="{{ url('public/assets/images/forms/06.png') }}"
                                                class="img-fluid avatar-90" alt="image">
                                        </div>
                                        <div class="forms-text d-flex flex-wrap
                                     justify-content-between text-left">
